      ...
      {features.map((feature) => (
        <div key={feature.name}>
          ...
          <div className="relative mt-10 pb-10">
            ...
            <div className="relative mx-auto aspect-[844/428] w-[52.75rem] overflow-hidden rounded-xl bg-slate-950 shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10">
              <Image
                src={feature.image}
                alt=""
                layout="fill"
          ...
          <Tab.Panels className="relative mt-20 overflow-hidden rounded-4xl bg-slate-200 px-14 py-16 xl:px-16">
            <div className="-mx-5 flex">
              {features.map((feature, featureIndex) => (
                ...
                >
                  <div className="relative aspect-[844/428] w-[52.75rem] overflow-hidden rounded-xl bg-slate-950 shadow-lg shadow-slate-900/5 ring-1 ring-slate-500/10">
                    <Image
                      src={feature.image}
                      alt=""
                      layout="fill"
...
export function SecondaryFeatures() {
  return (
    <section
      ...
      className="pt-20 pb-14 sm:pb-20 sm:pt-32 lg:pb-32 bg-slate-900"
    >
      <Container>
